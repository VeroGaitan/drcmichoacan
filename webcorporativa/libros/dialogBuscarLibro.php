...
if (filter_input(INPUT_POST, "funct") == NULL) {
    ...
    <div class="alert alert-danger" style="text-align: center"><b>*CAMPOS OBLIGATORIOS</b></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select style="width: 300px;" id="acto-notnull" class="comboboxAutocomplete" name="acto">
                    <option value="7">INSCRIPCION DE SENTENCIAS</option>
                    <?php
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select style="width: 300px" id="oficialia-notnull" class="comboboxAutocomplete" name="juzgado">
                    <option value="053-01">053-01 MORELIA MORELIA</option>
                    <?php
    ...
    <script>$(".comboboxAutocomplete").combobox()</script>
    <?php
    ...
    $R = "R:/" . $ACTO . "/16/" . $JM[0] . "/" . $JM[1] . "/" . $ANIO . "/" . $TOMO . "/" . $TBIS;
    $R_ = $ACTO . "/16/" . $JM[0] . "/" . $JM[1] . "/" . $ANIO . "/" . $TOMO . "/" . $TBIS;
    ...
    if ($registro = $libro->query($sqlInsert)) {
        echo json_encode(array("R" => $R_, "success" => "true", "sql" => $sqlInsert));
    } else {
